...
mixin _$AutocompletePrediction {
  ...
  $AutocompletePredictionCopyWith<AutocompletePrediction> get copyWith =>
      _$AutocompletePredictionCopyWithImpl<AutocompletePrediction>(
          this as AutocompletePrediction, _$identity);
...
abstract mixin class $AutocompletePredictionCopyWith<$Res> {
  factory $AutocompletePredictionCopyWith(AutocompletePrediction value,
          $Res Function(AutocompletePrediction) _then) =
      _$AutocompletePredictionCopyWithImpl;
  @useResult
  $Res call(
      {int? distanceMeters,
      String placeId,
...
class _AutocompletePrediction implements AutocompletePrediction {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AutocompletePredictionCopyWith<_AutocompletePrediction> get copyWith =>
      __$AutocompletePredictionCopyWithImpl<_AutocompletePrediction>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AutocompletePredictionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AutocompletePrediction &&
            (identical(other.distanceMeters, distanceMeters) ||
                other.distanceMeters == distanceMeters) &&
            (identical(other.placeId, placeId) || other.placeId == placeId) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$AutocompletePredictionCopyWith<$Res>
    implements $AutocompletePredictionCopyWith<$Res> {
  factory _$AutocompletePredictionCopyWith(_AutocompletePrediction value,
          $Res Function(_AutocompletePrediction) _then) =
      __$AutocompletePredictionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? distanceMeters,
